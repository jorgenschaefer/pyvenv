(ert-deftest pyvenv-set-file-virtualenv-should-activate-venv-if-none-set ()
  (with-temp-buffer
...
(ert-deftest pyvenv-set-file-virtualenv-should-ask-if-activate-different-venv ()
  (with-temp-buffer
    (mocker-let ((pyvenv-activate (env)
                                  ((:input '("/test/path"))))
...
(ert-deftest pyvenv-set-file-virtualenv-should-do-nothing-if-activate-same-venv ()
  (with-temp-buffer
    (let ((pyvenv-activate "/test/path")
...
(ert-deftest pyvenv-set-file-virtualenv-should-workon-venv-if-none-set ()
  (with-temp-buffer
...
(ert-deftest pyvenv-set-file-virtualenv-should-ask-if-workon-different-venv ()
  (with-temp-buffer
    (mocker-let ((pyvenv-workon (env)
                                ((:input '("test-venv"))))
...
(ert-deftest pyvenv-set-file-virtualenv-should-do-nothing-if-workon-same-venv ()
  (with-temp-buffer
    (let ((pyvenv-workon "test-venv")
